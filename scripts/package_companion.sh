...
cp "$PROJECT_DIR/broll-companion/load-app-url.bat"     "$DIST_DIR/broll-companion/"
cp "$PROJECT_DIR/broll-companion/app.url.example"      "$DIST_DIR/broll-companion/"
cp "$PROJECT_DIR/broll-companion/install.bat"         "$DIST_DIR/broll-companion/"
cp "$PROJECT_DIR/broll-companion/start-companion.bat" "$DIST_DIR/broll-companion/"
cp "$PROJECT_DIR/broll-companion/launch-companion-server.bat" "$DIST_DIR/broll-companion/"
